    ...
    while score0 < goal and score1 < goal:
        if player == 0:
            ...
            if is_swap(score0, score1):
                score0_initial = score0
                score0 = score1
                score1 = score0_initial
        elif player == 1:
            score1 += take_turn(strategy1(score1, score0), score0, dice)
            if is_swap(score1, score0):
                score1_initial = score1
                score1 = score0
                score0 = score1_initial
...
def announce_highest(who, previous_high=0, previous_score=0):
    ...
    def say(score0, score1):
        ...
        if gain > past:
            ...
            past = gain
        return announce_highest(who, past, prior)
    return say
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    maxx = 0
    while number <= 10:
        highest = make_averaged(roll_dice, num_samples)
        max_average = highest(number, dice)
        if max_average > maxx:
            maxx, max_scoring_num_rolls = max_average, number
        number += 1
